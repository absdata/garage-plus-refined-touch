...
const SuspensionService = () => {
  ...
  const serviceData = {
    ...
    shortDescription: 'Диагностика и ремонт подвески Mercedes-Benz W222',
    fullDescription: 'Комплексный ремонт подвески включает замену амортизаторов, пружин, втулок стабилизатора, шаровых опор и других элементов подвески. Особое внимание уделяется пневматической подвеске AIRMATIC.',
    images: [
    ...
    process: [
      ...
      'Замена втулок и шаровых опор',
      'Развал-схождение колес',
      'Тест-драйв и финальная проверка'
    ],
    pricing: { labor: 'от 15 000 ₽', parts: 'от 35 000 ₽', total: 'от 50 000 ₽' },
    duration: '1-2 дня',
    warranty: '1 год'
  };
