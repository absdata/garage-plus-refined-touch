...
const BrakeService = () => {
  ...
  const serviceData = {
    ...
    shortDescription: 'Комплексное обслуживание тормозной системы Mercedes-Benz W222',
    fullDescription: 'Полное обслуживание тормозной системы включает замену тормозных колодок, дисков, проверку тормозной жидкости, диагностику тормозных магистралей и электронных систем помощи при торможении.',
    images: [
    ...
    process: [
      ...
      'Замена тормозных дисков при необходимости',
      'Замена тормозной жидкости',
      'Прокачка тормозной системы',
      'Тестирование на дороге'
    ],
    pricing: { labor: 'от 8 000 ₽', parts: 'от 15 000 ₽', total: 'от 23 000 ₽' },
    duration: '3-4 часа',
    warranty: '1 год'
  };
