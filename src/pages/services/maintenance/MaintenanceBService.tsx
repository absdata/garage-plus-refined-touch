...
const MaintenanceBService = () => {
  ...
  const serviceData = {
    ...
    shortDescription: 'Расширенное техническое обслуживание Mercedes-Benz W222',
    fullDescription: 'Техническое обслуживание типа B - это расширенный комплекс работ, включающий все операции ТО A плюс дополнительные проверки и замены. Проводится с большим интервалом и включает замену воздушного фильтра, свечей зажигания и другие важные процедуры.',
    images: [
    ...
    problems: [
      ...
      'Снижение эффективности топливной системы',
      'Накопление отложений в системах',
    ...
    process: [
      ...
      'Сброс счетчика и адаптация'
    ],
    pricing: { labor: 'от 12 000 ₽', parts: 'от 18 000 ₽', total: 'от 30 000 ₽' },
    duration: '4-5 часов',
    warranty: '1 год'
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      ...
      {/* Main Content - same structure as above but with different data */}
