...
const CleaningService = () => {
  ...
  const serviceData = {
    title: 'Чистка систем двигателя',
    shortDescription: 'Комплексная чистка топливной системы и камеры сгорания',
    fullDescription: 'Профессиональная чистка топливной системы, форсунок, клапанов и камеры сгорания двигателя Mercedes-Benz W222. Удаление нагара и отложений для восстановления мощности и экономичности.',
    images: [
    ...
    problems: [
      ...
      'Неустойчивая работа на холостых',
    ...
    process: [
      ...
      'Удаление нагара с клапанов',
      'Промывка масляной системы',
      'Замена топливного фильтра',
      'Тестирование и настройка'
    ],
    pricing: { labor: 'от 8 000 ₽', parts: 'от 5 000 ₽', total: 'от 13 000 ₽' },
    duration: '4-6 часов',
    warranty: '6 месяцев'
  };
