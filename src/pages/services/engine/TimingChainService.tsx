    ...
    <ServiceLayout>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-slate-800">Признаки износа цепи ГРМ</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <Card className="max-w-md mx-auto border-0 shadow-lg rounded-2xl bg-white/90 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-xl text-center text-slate-800">Замена цепи ГРМ</CardTitle>
            </CardHeader>
