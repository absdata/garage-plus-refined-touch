...
const EcoDeleteService = () => {
  ...
  const serviceData = {
    title: 'Отключение экологических систем',
    shortDescription: 'Отключение EGR, DPF и других экологических систем',
    fullDescription: 'Профессиональное отключение экологических систем двигателя Mercedes-Benz W222, включая EGR, DPF, AdBlue. Программное и физическое удаление с перепрошивкой блока управления двигателем.',
    images: [
    ...
    problems: [
      'Частые засоры системы EGR',
      'Проблемы с сажевым фильтром DPF',
      'Расход жидкости AdBlue',
      'Аварийные режимы двигателя',
      'Снижение надежности систем'
    ],
    process: [
      'Диагностика экологических систем',
      'Создание резервной копии прошивки',
      'Программное отключение систем',
      'Физическое удаление компонентов',
      'Установка заглушек',
      'Перепрошивка блока управления',
      'Тестирование и настройка'
    ],
    pricing: { labor: 'от 25 000 ₽', parts: 'от 8 000 ₽', total: 'от 33 000 ₽' },
    duration: '1 день',
    warranty: '1 год'
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      ...
      <header className="bg-gradient-to-r from-slate-100/95 via-gray-100/95 to-slate-100/95 backdrop-blur-sm border-b border-slate-200 py-4 shadow-lg">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link to="/services/engine" className="flex items-center space-x-2 text-slate-700 hover:text-slate-900 transition-colors">
            <ArrowLeft className="h-5 w-5" />
            <span>Назад к ДВС</span>
          </Link>
