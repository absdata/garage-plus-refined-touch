...
const SevenGTronicService = () => {
  ...
  const serviceData = {
    ...
    shortDescription: 'Профессиональное обслуживание АКПП 7G-TRONIC Mercedes-Benz',
    ...
    problems: [
      ...
      'Задержки при включении D или R',
      'Аварийный режим коробки',
      'Перегрев трансмиссии',
      'Некорректная работа адаптации'
    ],
    process: [
      'Компьютерная диагностика АКПП',
      'Проверка уровня и качества масла',
      'Слив старого масла и снятие поддона',
      'Замена фильтра и магнитов',
      'Заливка нового масла ATF MB 236.14',
      'Адаптация коробки передач',
      'Дорожные испытания'
    ],
    pricing: { labor: 'от 6 000 ₽', parts: 'от 12 000 ₽', total: 'от 18 000 ₽' },
    duration: '3-4 часа',
    warranty: '1 год'
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      ...
      <header className="bg-gradient-to-r from-slate-100/95 via-gray-100/95 to-slate-100/95 backdrop-blur-sm border-b border-slate-200 py-4 shadow-lg">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link to="/services/transmission" className="flex items-center space-x-2 text-slate-700 hover:text-slate-900 transition-colors">
            <ArrowLeft className="h-5 w-5" />
            <span>Назад к АКПП</span>
          </Link>
