...
const InteriorService = () => {
  ...
  const serviceData = {
    title: 'Тюнинг салона',
    shortDescription: 'Эксклюзивная отделка салона Mercedes-Benz W222',
    fullDescription: 'Премиальный тюнинг салона Mercedes-Benz W222 включает перетяжку кожей, установку эксклюзивной отделки, модернизацию мультимедийной системы и создание индивидуального дизайна интерьера.',
    images: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      ...
      <header className="bg-gradient-to-r from-slate-100/95 via-gray-100/95 to-slate-100/95 backdrop-blur-sm border-b border-slate-200 py-4 shadow-lg">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link to="/services/tuning" className="flex items-center space-x-2 text-slate-700 hover:text-slate-900 transition-colors">
            <ArrowLeft className="h-5 w-5" />
            <span>Назад к тюнингу</span>
          </Link>
